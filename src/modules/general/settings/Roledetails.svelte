...
import { roleStore, roleVal } from '../../../stores/stores';
...
<tbody class="bg-white divide-y divide-gray-200 overflow-y-scroll h-15">                                        
    <tr>                                            
        ...
        <td class="px-10 py-1 whitespace-nowrap"><input type="checkbox" class="h-4 w-4 text-red-600" on:change={()=>onReadChangeIt({itemIndex})}  bind:checked={basketsd[basketIndex].submenu[itemIndex].read}></td>
