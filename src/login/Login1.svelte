...
//import Modals from '../common/modals/components/Modals.svelte';
		import { redirectCall,signinGoogle } from '../services/authservice1/Firebase';
...
var auths = $session.get('authstore');

$: showmodal = false;


	function handleSubmit(){
		let mydata= {user:user, password:password};
		/*fetch('https://8ae8f228c190b1f0ecdf42441b1e0b31.m.pipedream.net',{
    			method: 'post',
    			body: JSON.stringify(mydata)
			  }).then( (e)=> /*e.json().then( (e1) => console.log(e));*/			  
			  Httpclient.post('https://8ae8f228c190b1f0ecdf42441b1e0b31.m.pipedream.net',mydata).then( (e)=> console.log(e));
		}
